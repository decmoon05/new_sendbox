...
- [x] 프로젝트 구조 및 아키텍처 설계
- [x] Core 레이어 구현 (상수, 에러 처리, 유틸리티, 테마)
- [x] Domain 레이어 구현 (엔티티, 리포지토리 인터페이스, UseCase)
- [x] Data 레이어 구현 (모델, 데이터소스, 리포지토리, 서비스)
- [x] Presentation 레이어 기본 구조 (라우팅, 기본 페이지)
- [x] Firebase 초기화 및 설정
- [x] Riverpod 상태 관리 설정
- [x] 채팅 목록 UI 구현
- [x] 프로필 목록 UI 구현

**자세한 내용:** [현재 개발 상태](docs/02-for-developers/CURRENT_STATUS.md)
